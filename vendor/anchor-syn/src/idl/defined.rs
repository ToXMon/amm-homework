...
pub fn gen_idl_type(
    ...
    match ty {
        ...
        syn::Type::Path(path) => {
            ...
            // This legacy toolchain does not expose proc_macro2's
            // semver-exempt source_file API. The AMM has no external IDL
            // aliases, so crate-local type resolution below is sufficient.
            #[cfg(any())]
            {
